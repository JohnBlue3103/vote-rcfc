...
async function loadChronologie() {
  ...
  for (const session of sessions) {
    ...
    html += '<div class="chrono-session">'
      ...
      + '<div style="font-size:0.75rem;color:#C8A84B;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:8px;">🗳️ Membres votants de la session (' + votants.length + '/16)</div>'
